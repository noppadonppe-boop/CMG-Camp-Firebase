...
import {
  ClipboardList, History, ArrowRight, ShieldCheck, ShieldAlert,
    ...
    <div>
      ...
      <div className="mb-6 rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
        ...
        <div className="h-3 w-full rounded-full bg-gray-200">
          <div className="h-3 rounded-full bg-emerald-500 transition-all duration-700" style={{ width: `${passRate}%` }} />
        </div>
        <p className="mt-2 text-xs text-gray-400">ผ่าน {SUMMARY.passedCount} จาก {SUMMARY.totalInspections} ครั้ง</p>
      </div>

      <h2 className="mb-3 text-sm font-semibold uppercase tracking-wide text-gray-500">เมนูหลัก</h2>
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <Link to="/hygiene/inspect" className="group flex items-start gap-4 rounded-2xl border-2 border-gray-200 bg-white p-5 shadow-sm transition hover:border-blue-400 hover:shadow-md active:scale-[0.99]">
          <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-blue-600 shadow-sm">
            <ClipboardList className="h-6 w-6 text-white" />
          </div>
          <div className="flex-1">
            <p className="text-base font-bold text-gray-800 group-hover:text-blue-700">ฟอร์มตรวจสุขอนามัย</p>
            <p className="mt-0.5 text-sm text-gray-500">กรอกผลการตรวจสอบรายห้องตามรายการตรวจ 4 หมวด 13 รายการ</p>
        ...
        <Link to="/hygiene/history" className="group flex items-start gap-4 rounded-2xl border-2 border-gray-200 bg-white p-5 shadow-sm transition hover:border-indigo-400 hover:shadow-md active:scale-[0.99]">
          <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-indigo-600 shadow-sm">
            <History className="h-6 w-6 text-white" />
          </div>
          <div className="flex-1">
            <p className="text-base font-bold text-gray-800 group-hover:text-indigo-700">ประวัติการตรวจ</p>
            <p className="mt-0.5 text-sm text-gray-500">ดูผลการตรวจย้อนหลัง สรุปรายห้อง และรายงานค่าปรับที่เกิดขึ้น</p>
            <div className="mt-3 text-xs text-gray-400"><span>{SUMMARY.totalInspections} ครั้งในเดือนนี้</span></div>
          </div>
